...
public enum Code implements BaseCode {
    ...
    TOO_MANY_REQUESTS(HttpStatus.TOO_MANY_REQUESTS, "COMMON429", "요청이 너무 많습니다. 잠시 후 다시 시도해주세요."),
    ...
    PAYMENT_UNKNOWN_STATUS_RETRY(HttpStatus.ACCEPTED, "PAYMENT_2020", "이전 결제 요청의 상태를 확인 중입니다. 잠시 후 다시 시도해주세요."),
    ...
    // FCM
    // FEIGN_CLIENT_ERROR_400(HttpStatus.BAD_REQUEST, "4001", "BAD REQUEST in feign
    // client"),
    // FEIGN_CLIENT_ERROR_500(HttpStatus.INTERNAL_SERVER_ERROR, "5001", "Inter
    // server Error in feign client"),
