...
//
///**
// * @deprecated ChatMessageService로 대체됨 - Redis pub/sub을 활용한 통합 서비스
// */
//@Deprecated
//@Service
...
//    }
//
//    public void broadcastMessage(ChatMessageDto chatMessageDto) {
//        // 채팅방 참여자들에게 메시지 전송
//        log.info("채팅방 내 메시지 전송 messageId={}, roomId={}", chatMessageDto.getId(), chatMessageDto.getRoomId());
